...
def main():
    ...
    print(type(obs_resampled_with_noise_2[train_idx]), type(labels_resampled_factorized[train_idx]))
    print(obs_resampled_with_noise_2[train_idx].shape, labels_resampled_factorized[train_idx].shape)
